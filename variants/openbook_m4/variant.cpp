...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTB,  4, PIO_ANALOG, PIN_ATTR_ANALOG_ALT, ADC_Channel6, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 },   // A7, D21 - mic raw
 ...
 // ----------------------
  ...
  // 41..43 - e-paper and SRAM SPI port + control pins
  // --------------------
  ...
  { PORTB, 12, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_12 },  // SERCOM 4.0 MISO OR button latch on rev 4
  { PORTB,  7, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 },  // D44 e-paper CS
  { PORTB,  5, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 },  // D45 e-paper DC
  ...
  // D53 chip select for SRAM chip on SERCOM4, OR button clock on rev 4		   // D53 amplified mic signal
